...
export const auth = betterAuth({
  ...
  jwt: {
    ...
    issuer: process.env.BETTER_AUTH_JWT_ISS || process.env.AUTH_JWT_ISS || "passion-jerseys-auth",
    audience: process.env.BETTER_AUTH_JWT_AUD || process.env.AUTH_JWT_AUD || "passion-jerseys-api",
    expiresIn: "1h",
  },
  plugins: [
    username({
