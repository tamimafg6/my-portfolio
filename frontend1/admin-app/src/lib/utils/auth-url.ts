 ...
 *   baseURL should be: https://passion-jerseys-ujthe.ondigitalocean.app/auth/api/auth (include /api/auth)
 *   BetterAuth will call: https://...ondigitalocean.app/auth/api/auth/get-session ✅
 * 
